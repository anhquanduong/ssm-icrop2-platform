...
SYNONYM_MAP = {
    ...
    "bdEMREJU": ["bdemreju", "bd_emreju", "emr_to_eju", "emrtoeju", "emergence to juvenile", "bdemrr1", "bdemrr1 ="],
    "bdEJUPNI": ["bdejupni", "bdejupni =", "ejupni", "eju to pni", "bdr1r3", "bdr1r3 ="],
    "bdPNITLM": ["bdpnitlm", "bdpnitlm =", "pnitlm", "pni to tlm", "bdr3r5", "bdr3r5 ="],
    "bdTLMANT": ["bdtlmant", "bdtlmant =", "tlmant", "tlm to ant", "bdr5r7", "bdr5r7 ="],
    "bdANTBSG": ["bdantbsg", "bdantbsg =", "antbsg", "ant to bsg", "bdr7r8", "bdr7r8 ="],
    "bdBSGPM": ["bdbsgpm", "bdbsgpm =", "bsgpm", "bsg to pm", "silking to maturity", "seed fill duration"],
    "bdPMHM": ["bdpmhm", "bdpmhm =", "pmhm", "pm to hm"],
    "PHYL": ["phyl", "phyl =", "phyllo", "phyllochron", "phyl_temp", "phyllochron temperature", "phyl1", "phyl2"],
    ...
    "TKILL": ["tkill", "tkill =", "t_kill", "frost_kill", "frost_threshold", "killing temp", "frzth", "frzth ="],
    ...
    "IRUE": ["irue", "irue =", "rue_max", "rue", "iruemax", "radiation use efficiency", "irue1", "irue1 ="],
    ...
    "MEED": ["meed", "meed =", "max_root_depth", "max_rooting_depth", "max root depth", "eed", "eed ="],
    "GRTDP": ["grtdp", "grtdp =", "root_growth_rate", "daily root growth"],
    "TEC": ["tec", "tec =", "tec_coeff", "transp_eff_coeff", "transpiration efficiency", "tec350", "tec350 ="],
    ...
    "SNCS": ["sncs", "sncs =", "stem_n_senesced", "sncs1", "sncs1 =", "sncs2", "sncs2 ="],
    "GNC": ["gnc", "gnc =", "grain_n_conc", "gncmin", "gncmin =", "gncmax", "gncmax ="],
